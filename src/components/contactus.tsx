...
const ContactUs: React.FC = () => {
    ...
    return (
        <section className="my-14 md:my-16 lg:my-20 flex items-center justify-between  max-[640px]:flex-col mx-4">
            ...
            <div className="rightside sm:ml-2 sm:bg-[#444444] text-start p-3 md:p-10 lg:p-15 sm:w-1/2 w-full max-[640px]:mt-4">
            <div>
                <h1 className="text-[#fbe7c2] text-4xl font-semibold mb-3">Contact us</h1>
                ...
                <form>
                    ...
                    <p className="mb-4"> <input type="checkbox" className="rounded-md bg-transparent  border-[#747474]" /> <span className="text-[#f7f7f7]">I agree to the </span> <a href="#" className="cursor-pointer">Privacy Policy</a> </p>
