...
const Hero: React.FC = () => {
    return(
        <section className="flex sm:h-screen justify-between items-center max-[640px]:flex-col">
            <div className="leftside relative w-full sm:w-1/2 h-[100vh] sm:h-auto  sm:p-10">
                <img  src={"images/image1.jpeg"} alt="Background" className="absolute inset-0 w-full h-full object-cover sm:static sm:hidden" />
            
                <div className="relative z-10 flex flex-col  justify-end bottom-0 h-full lg:p-9 md:p-6 p-3 lg:justify-center items-start text-left bg-black/50 sm:bg-transparent">
                    <h1 className="text-white text-3xl font-bold mb-4">Custom and Built-in <span>Furniture</span></h1>
                    <p className="text-[#f7f7f7] mb-4">Production of an interior items from the material chosen by the client</p>
                    <button className="bg-[#fbe7c2] text-[#b0b0b0] px-2 md:px-6 sm:px-2 py-2 rounded w-full sm:w-4/6 lg:w-1/2">Order a Project</button>
                </div>
            </div>
